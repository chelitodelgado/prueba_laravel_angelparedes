    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header text-center">
                <h4 class="text-muted">Agregar grupo</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form method="POST" action="{{route('insertar.grupo')}}" enctype="multipart/form-data">
                        @csrf
                            <div class="row">
                                ...
                                <div class="col-xl-6 py-2">
                                    <div class="form-group">
                                        <div class="form-group py-4">
                                            <input type="submit" class="btn btn-block btn-outline-primary px-4" value="Guardar">
                                        </div>
                                    </div>
                                </div>
                            </div>
